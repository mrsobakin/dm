...
Бинарное отношение R на множестве $A^2$ называется рефлексивным, если для каждого элемента a из A выполняется условие (a, a) принадлежит R.

#### 24. Свойство иррефлексивности

Бинарное отношение R на множестве $A^2$ называется иррефлексивным, если для каждого элемента a из A выполняется условие (a, a) не принадлежит R.

#### 25. Свойство корефлексивности

Бинарное отношение R на множестве $A^2$ называется корефлексивным, если для каждой пары (a, b) из R следует что a = b

#### 26. Свойство симметричности

Бинарное отношение R на множестве $A^2$ называется симметричным, если для любых элементов a и b из A, если (a, b) принадлежит R, то и (b, a) принадлежит R.

#### 27. Свойство асимметричности

Бинарное отношение R на множестве $A^2$ называется асимметричным, если для любых элементов a и b из A, если (a, b) принадлежит R, то (b, a) не принадлежит R.

#### 28. Свойство антисимметричности

Бинарное отношение R на множестве $A^2$ называется антисимметричным, если для любых различных элементов a и b из A, если (a, b) и (b, a) принадлежат R, то a = b.

#### 29. Свойство транзитивности

Бинарное отношение R на множестве $A^2$ называется транзитивным, если для любых элементов a, b и c из A, если (a, b) и (b, c) принадлежат R, то и (a, c) принадлежит R.

#### 30. Свойство интранзитивности

Бинарное отношение R на множестве $A^2$ называется интранзитивным (антитранзитивным), если для любых элементов a, b и c из A, если (a, b) и (b, c) принадлежат R, то (a, c) не принадлежит R.

#### 31. Свойство евклидовости

Бинарное отношение R на множестве $A^2$ называется евклидовым, если для любых элементов a, b и c из A, если (a, b) и (a, c) принадлежат R, то и (b, c) принадлежит R. (првая. левая похоже только "влево")
...
Бинарное отношение R на множестве $M^2$ называется отношением эквивалентности, если оно обладает свойствами рефлексивности, симметричности и транзитивности.
